...
root_dir = 'D:\\LiTS\\models\\AttentionUnet'
print(root_dir)
...
# Write to file
with open('D:\\LiTS\\models\\AttentionUnet\\metrics.json', 'w') as file:
    file.write(json_data)

###------------------------------------Plot Loss, metric------------------------------------------------

'''
with open('D:\\LiTS\\models\\AttentionUnet\\metrics.json', 'r') as file:
    json_data = file.read()
...
loss_graph = "D:\\LiTS\\models\\AttentionUnet\\loss_graph"
...
with torch.no_grad():
    for num in range(6):
        ...
        nib.save(img,f"D:\\LiTS\\models\\AttentionUnet\\val_result\\{40}-output.nii.gz")
        nib.save(label,f"D:\\LiTS\\models\\AttentionUnet\\val_result\\{40}-label.nii.gz")
