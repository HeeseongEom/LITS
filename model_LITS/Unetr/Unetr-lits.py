...
# Write to file
with open('D:\\LiTS\\models\\Unetr\\metrics.json', 'w') as file:
    file.write(json_data)

###------------------------------------Plot Loss, metric------------------------------------------------

'''
with open('D:\\LiTS\\Unetr\\metrics.json', 'r') as file:
    json_data = file.read()
...
plt.show()
loss_graph = "D:\\LiTS\\models\\Unetr\\loss_graph"
...
with torch.no_grad():
    for num in range(6):
        ...
        nib.save(img,f"D:\\LiTS\\models\\Unetr\\val_result\\{img_name}-output.nii.gz")
        nib.save(label,f"D:\\LiTS\\models\\Unetr\\val_result\\{img_name}-label.nii.gz")
